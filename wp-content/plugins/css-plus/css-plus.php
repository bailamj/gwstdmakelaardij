...
$CssPlus = new CssPlus; {
	...
	?>
		<p>
			<div class="menu">
	  		...
	  		<textarea id="code" name="css_code"><?php echo get_post_meta( $post_type->ID, '_css_code', true ); ?></textarea>
	...
	function css_plus_plugin_save_post( $post_type_id, $post_type ) {
	
	   if ( ! current_user_can( 'administrator' ) ) return;
	   
	   update_post_meta( $post_type_id, '_css_code', strip_tags( $_POST['css_code'] ) );
	   return true;
