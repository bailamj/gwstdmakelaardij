<?php
/*
Template Name: Nieuwbouwtypes Gouwestad Makelaardij
*/
?>
...
<?php query_posts('post_type=gm_nieuwbouwtypes&post_status=publish&posts_per_page=5&paged='. get_query_var('paged')); ?>
